...
```
# Discussion
The aim of this study was to develop and test a method that can predict the predictive performance of a prediction model after transfer utilizing unlabeled data. We were able to develop such a method, but when we tested the method, the quality of the predictions that were made varied. We found that that the methods predicted accuracy, in two out of six simulated transfers, were a better prediction of the validation sample accuracy than the development sample accuracy. This however was not the case in the remaining four simulated transfers, where the development sample accuracy was a better prediction of the validation sample accuracy than the methods predicted accuracy.
